...
public class UpdateRecipeActivity extends AppCompatActivity {
    ...
    Uri uri;
    EditText txt_name,txt_description, txt_duration;
    String imageUrl, userID;
    String key, oldImageUrl, recipeKey;
    String recipename, recipeDescription, recipeDuration;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_duration = findViewById(R.id.text_duration);
        ...
        if(bundle != null){
            ...
            txt_duration.setText(bundle.getString("durationKey"));
    ...
    public void uploadRecipe() {
        ...
        FoodData foodData = new FoodData(
                recipename, recipeDescription, recipeDuration,imageUrl);
        ...
        documentReference.update("itemName",recipename,"itemDescription",recipeDescription, "itemDuration",recipeDuration, "itemImage",imageUrl)
        ...
        intent.putExtra("duration",recipeDuration);
    ...
    public void btnUpdateRecipe(View view) {
        ...
        recipeDuration = txt_duration.getText().toString().trim();
