...
public class Upload_Recipe extends AppCompatActivity {
    ...
    public void uploadRecipe(final View view) {
        ...
        FoodData foodData = new FoodData(txt_name.getText().toString(),txt_description.getText().toString(),txt_duration.getText().toString(),imageUrl);
        ...
        FoodData fireStoreFoodData = new FoodData(txt_name.getText().toString(),txt_description.getText().toString(),txt_duration.getText().toString(),imageUrl,myCurrentDateTime,recipeID);
