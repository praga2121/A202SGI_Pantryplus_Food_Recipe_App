...
public class DetailActivity extends AppCompatActivity {
    ...
    TextView foodDescription, recipeName, recipeDuration;
    ImageView foodImage, like_imageView, dislike_imagView;
    Button btnUpdate, btnDelete;
    String recipeItemName, recipeItemDuration, recipeDescription;
    String key = "";
    String compareKey = "";
    String recipeKey = "";
    String imageUrl = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recipeDuration = findViewById(R.id.txtDuration);
        ...
        if (firebaseAuth.getCurrentUser() == null){
            finish();
            Intent intent = new Intent(this, com.example.pantry.LoginActivity.class);
            ...
            if (mBundle != null) {
                ...
                recipeItemDuration = mBundle.getString("duration");
                recipeDuration.setText(recipeItemDuration);
            ...
            favoriteDocumentReference.collection("Favorites").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                ...
                public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                    for (QueryDocumentSnapshot documentSnapshot : queryDocumentSnapshots) {
                        com.example.pantry.FoodData foodData = documentSnapshot.toObject(com.example.pantry.FoodData.class);
    ...
    public void btnUpdateRecipe(View view) {
        ...
        startActivity(new Intent(getApplicationContext(), com.example.pantry.UpdateRecipeActivity.class)
                .putExtra("recipeNameKey", recipeName.getText().toString())
                .putExtra("descriptionKey",foodDescription.getText().toString())
                .putExtra("durationKey",recipeDuration.getText().toString())
    ...
    public void onBackPressed() {
        Intent intent=new Intent(this, com.example.pantry.MainActivity.class);
        startActivity(intent);
        finish();
    }
    ...
    public void btnDislike(final View view) {
        ...
        com.example.pantry.FoodData fireStoreFoodData = new com.example.pantry.FoodData(recipeItemName,recipeDescription,recipeItemDuration,imageUrl,key,favoriteKey);
