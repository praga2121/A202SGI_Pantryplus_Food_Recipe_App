...
public class MyAdapter extends RecyclerView.Adapter<FoodViewHolder>{
    ...
    public void onBindViewHolder(@NonNull final FoodViewHolder holder, int position) {
        ...
        holder.mDuration.setText(myFoodList.get(position).getItemDuration());
        ...
        holder.mCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("duration",myFoodList.get(holder.getAdapterPosition()).getItemDuration());
...
class FoodViewHolder extends RecyclerView.ViewHolder {
    ...
    ImageView imageView;
    TextView mTitle, mDescription, mDuration;
    CardView mCardView;
